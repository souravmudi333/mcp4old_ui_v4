...
class TeamResponse(BaseModel):
    ...
    # 🔥 UI RELATIONSHIP FLAGS (ADD THESE)
    is_owner: bool = Field(False, description="Whether current user owns the team")
    is_member: bool = Field(False, description="Whether current user is a member")
    can_join: bool = Field(False, description="Whether current user can request to join")
    is_admin: bool = Field(False, description="Whether current user is team admin")
