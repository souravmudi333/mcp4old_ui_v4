...
class Permissions:
    ...
    TEAMS_DISCOVER = "teams.discover" #new permission
    TEAMS_ACCEPT = "teams.accept"    #new permission
    TEAMS_LIST = "teams.list"         #new permission
    TEAMS_INVITE = "teams.invite"      #new permission
    ...
    # Gateway Permissions
    GATEWAY_CREATE = "gateways.create"
    GATEWAY_READ = "gateways.read"
    GATEWAY_UPDATE = "gateways.update"
    GATEWAY_DELETE = "gateways.delete"
    GATEWAY_MANAGE = "gateways.manage"
    ...
    # Team token permissions 
    TOKENS_TEAM_CREATE = "tokens.team.create"
    TOKENS_TEAM_READ = "tokens.team.read"

    # Admin token permissions
    TOKENS_ADMIN_READ = "tokens.admin.read"
    TOKENS_ADMIN_REVOKE = "tokens.admin.revoke"
    TOKENS_ADMIN_USAGE = "tokens.admin.usage"
    TOKENS_ADMIN_TEAM_READ = "tokens.admin.team.read"
    TOKENS_ADMIN_TEAM_CREATE = "tokens.admin.team.create"
